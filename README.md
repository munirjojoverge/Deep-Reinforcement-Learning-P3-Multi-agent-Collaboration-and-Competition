...
The observation space (for each agent) consists of 8 variables corresponding to the position and velocity of the ball and racket. Each agent receives its own, local observation.  Two continuous actions are available, corresponding to movement toward (or away from) the net, and jumping. Both these actions must be within the range [-1,1] 
...
Follow the instructions on this repository `Tennis.ipynb` to get started with training of the agents!
...
### (Comming up soon) Challenge: Crawler Environment

I'm planning to solve the more difficult **Soccer** environment.
